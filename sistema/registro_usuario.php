...
include "../conexion.php";
    if(!empty($_POST)){
        ...
        empty($_POST['clave']) ||empty($_POST['nombre']) ||empty($_POST['rol'])){
            ...
            if($result>0){
                ...
                if($query_insert){
                    $alert='<p class="msg_save">El usuario fue registrado con exito.</p>';
                }else{
...
<body>
    ...
    <section id="container">
        <div class="form_register">
            <h1><i class="fas fa-user"></i> Registro usuarios</h1>
            <hr>
            <div class="alert"><?php echo  isset($alert) ? $alert : '' ?></div>
            <form action="" method="post">
                <label for="nombre">Nombre</label>
                <input type="" name="nombre" id="nombre" placeholder="Nombre completo">
