...
<body>
    ...
    <section id="container">
        <div class="limiter">
            ...
            $sql_registe=mysqli_query($conection,"SELECT COUNT(*) AS total_registro FROM  factura WHERE estatus!=11 and usuario=$usuario_activo");
        ...
        ON f.idempresa=c.id
            WHERE f.estatus != 11 and f.usuario=$usuario_activo
