...
if(isset($_REQUEST['busqueda']) && $_REQUEST['busqueda'] == ''){
    header("location: lista_ventas_administacion.php");
}
                ...
                <div class="wrap-table100">
                    <div class="table100">
                        ...
                        <table>
                            ...
                            <?php
            //paginador
            $sql_registe=mysqli_query($conection,"SELECT COUNT(*) AS total_registro FROM  factura WHERE $where and estatus>= 8");
            ...
            if($result>0){
                while($data=mysqli_fetch_array($query)){
                    ...
                    elseif ($data["estatus"]==10){
                        $estado = '<span class="pagada">Por pagar.</span>';
                    }
